<template>
    <div id="write">
        <div class="write-content write-contents-1">
            <h3>编辑文章</h3>
            <Form ref="subInfo" :model="subInfo" class="content">
                <!--文章标题-->
                ...
                <mavon-editor ref="md" @imgAdd="$imgAdd" @imgDel="$imgDel"
                              :ishljs="true" v-model="subInfo.markdown" default_open="edit"
        ...
        <div class="container">
            <div class="write-content write-contents-2">
                ...
                <div slot="content" style="margin: 20px auto;">
                    <Form ref="subInfo" :model="subInfo" label-position="top">

                        <!--日期-->
                        <FormItem label="发布日期" prop="发布日期">
                                <DatePicker size="default" :transfer="true" type="datetime" format="yyyy-MM-dd HH:mm"
                                            placeholder="更改发布时间" style="width: 100%" v-model="selectDate" />

                        </FormItem>
                        <!--标签-->
                        <FormItem label="标签" prop="标签">
                            <label>
                                <Select transfer size="default" v-model="selectTagName" :multiple="true"
                                        :value="selectTagName">
                        ...
                        <FormItem label="分类" prop="分类">
                            <label>
                                <Select transfer size="default" v-model="subInfo.classic" placeholder="选择你的分类">
                                    <Option v-for="(classItem,key) in classicList" :key="key"
                        ...
                        <!--封面图-->
                        <!--上传文件-->
                        <Button size="default" long type="primary" :loading="loading" icon="checkmark-round"
                                @click="toLoading" style="margin: 30px auto;">
                ...
                <div slot="content">
                    <Form ref="subInfo" :model="subInfo" label-position="top">
                        ...
                        <FormItem label="简介" prop="简介内容">
                            <label>
                                <Input size="default" v-model="subInfo.abstract" type="textarea"
