<template>
    <div class="all-express">
        <div class="express">
            ...
            <div class="attion">
                <i-Button size="default" type="success" @click="goToHome()">《 点击此处返回首页</i-Button>
                <i-Button size="default" type="info" @click="goToImg()">加群点击此处</i-Button>

                <p>注意：这里数据仅供参考，一切以实际运费为准，服务提供至月底。单位(元)</p>
            </div>

            <div class="from-title">寄往地区选择：</div><i-select v-model="model1" size="default" :transfer="false">
