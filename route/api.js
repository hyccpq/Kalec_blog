...
const searchAdArticle = articleAPI.SEARCH_AD_ARTICLE_API
// upload
...
const getCaptcha = articleAPI.GET_CAPTCHA
/**
 *  admin
 */
router.post('/addArticle',checkToken,add)
router.put('/editArticle',checkToken,editArticle)
router.get('/searchAdArticle',checkToken,searchAdArticle)

router.get('/searchAll',checkToken,searchAll)
router.get('/searchShowArt',checkToken,searchShowArt)
router.delete('/deleteReply',checkToken,deleteReply)
router.delete('/deleteArticle',checkToken,deleteArticle)
router.delete('/deleteMark',checkToken,deleteMark)
router.put('/editShow',checkToken,editShow)
