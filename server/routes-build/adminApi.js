...
let AdminApiControllers =
  ((_dec = controller('/api/admin/v0')),
  (_dec2 = post('/login')),
  (_dec3 = required({
    body: ['user', 'password']
  })),
  (_dec4 = post('/addArticle')),
  (_dec5 = admin('admin')),
  (_dec6 = put('/editArticle')),
  (_dec7 = admin('admin')),
  (_dec8 = get('/searchAll')),
  (_dec9 = get('/searchAdArticle')),
  (_dec10 = admin('admin')),
  (_dec11 = put('/editShow')),
  (_dec12 = admin('admin')),
  (_dec13 = del('/deleteArticle')),
  (_dec14 = admin('admin')),
  (_dec15 = post('/upload')),
  (_dec16 = admin('admin')),
  (_dec17 = fileUpload('articleImage')),
  (_dec18 = get('/searchOneComment')),
  (_dec19 = post('/addAdMark')),
  (_dec20 = admin('admin')),
  (_dec21 = post('/addAdReply')),
  (_dec22 = admin('admin')),
  (_dec23 = del('/deleteReply')),
  (_dec24 = admin('admin')),
  (_dec25 = del('/deleteMark')),
  (_dec26 = admin('admin')),
  (_dec27 = post('/addTagOrClassic')),
  (_dec28 = admin('admin')),
  _dec(
    (_class =
      ((_class2 =
        ((_temp = _class3 = class AdminApiControllers {
        ...
        _defineProperty(_class3, 'isManage', true),
        _temp)),
      (_applyDecoratedDescriptor(
        _class2.prototype,
        'login',
        [_dec2, _dec3],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'login'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'addArticle',
        [_dec4, auth, _dec5],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'addArticle'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'editArticle',
        [_dec6, auth, _dec7],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'editArticle'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'searchAll',
        [_dec8, auth],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'searchAll'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'searchAdArticle',
        [_dec9, auth, _dec10],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'searchAdArticle'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'editArticleShow',
        [_dec11, auth, _dec12],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'editArticleShow'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'deleteMyArticle',
        [_dec13, auth, _dec14],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'deleteMyArticle'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'upload',
        [_dec15, _dec16, _dec17],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'upload'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'searchOne',
        [_dec18],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'searchOne'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'addMark',
        [_dec19, auth, _dec20],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'addMark'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'addReply',
        [_dec21, auth, _dec22],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'addReply'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'deleteReply',
        [_dec23, auth, _dec24],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'deleteReply'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'deleteMark',
        [_dec25, auth, _dec26],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'deleteMark'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'addTagOrClassic',
        [_dec27, auth, _dec28],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'addTagOrClassic'),
        _class2.prototype
      )),
      _class2))
  ) || _class)
