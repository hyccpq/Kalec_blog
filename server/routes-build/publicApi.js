...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _class3;
...
let PublicApiControllers = (_dec = controller('/api/public'), _dec2 = get('/indexPage'), _dec3 = get('/searchOne'), _dec4 = get('/searchAllTags'), _dec5 = post('/addMark'), _dec6 = post('/addReply'), _dec7 = get('/getCaptcha'), _dec8 = post('/compressCaptcha'), _dec(_class = (_class2 = (_class3 = class PublicApiControllers {
