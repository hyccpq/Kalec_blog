...
let PublicApiControllers =
  ((_dec = controller('/api/public')),
  (_dec2 = get('/indexPage')),
  (_dec3 = get('/searchOne')),
  (_dec4 = get('/searchAllTags')),
  (_dec5 = post('/addMark')),
  (_dec6 = post('/addReply')),
  (_dec7 = get('/getCaptcha')),
  (_dec8 = post('/compressCaptcha')),
  _dec(
    (_class =
      ((_class2 =
        ((_temp = _class3 = class PublicApiControllers {
        ...
        _defineProperty(_class3, 'isManage', false),
        _temp)),
      (_applyDecoratedDescriptor(
        _class2.prototype,
        'indexPage',
        [_dec2],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'indexPage'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
      ...
      _applyDecoratedDescriptor(
        ...
        'searchAllTags',
        [_dec4],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'searchAllTags'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'addMark',
        [_dec5, compresCaptcha],
      ...
      _applyDecoratedDescriptor(
        ...
        'getCaptcha',
        [_dec7],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'getCaptcha'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'compressCaptchaAll',
        [_dec8, compresCaptcha],
