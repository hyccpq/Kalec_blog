...
let AdminGalleryApi =
  ((_dec = controller('/api/gallery/v0')),
  (_dec2 = post('/addGallery')),
  (_dec3 = admin('admin')),
  (_dec4 = required({
    body: ['title', 'author', 'description', 'isPwd']
  })),
  (_dec5 = put('/editGallery')),
  (_dec6 = admin('admin')),
  (_dec7 = required({
    body: ['id', 'title', 'author', 'description', 'isPwd']
  })),
  (_dec8 = get('/adSearchAllGallery')),
  (_dec9 = del('/deleteGallery')),
  (_dec10 = admin('admin')),
  (_dec11 = required({
    query: ['id']
  })),
  (_dec12 = put('/showGallery')),
  (_dec13 = admin('admin')),
  (_dec14 = required({
    body: ['id', 'show']
  })),
  (_dec15 = post('/updatedImages')),
  (_dec16 = admin('admin')),
  (_dec17 = required({
    body: ['id', 'imageListInf']
  })),
  (_dec18 = get('/getGalleryImages')),
  (_dec19 = required({
    query: ['id']
  })),
  (_dec20 = get('/getUpdateToken')),
  (_dec21 = admin('admin')),
  (_dec22 = del('/images')),
  (_dec23 = admin('admin')),
  (_dec24 = required({
  ...
  _dec(
    (_class =
      ((_class2 =
        ((_temp = _class3 = class AdminGalleryApi {
          /**
           * 相册相关
           */
      ...
      (_applyDecoratedDescriptor(
        _class2.prototype,
        'createGallery',
        [_dec2, auth, _dec3, _dec4],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'createGallery'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'changeGallery',
        [_dec5, auth, _dec6, _dec7],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'changeGallery'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
      ...
      _applyDecoratedDescriptor(
        _class2.prototype,
        'deleteGallery',
        [_dec9, auth, _dec10, _dec11],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'deleteGallery'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'showGallery',
        [_dec12, auth, _dec13, _dec14],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'showGallery'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'updateImages',
        [_dec15, auth, _dec16, _dec17],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'updateImages'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'getGalleryImages',
        [_dec18, auth, _dec19],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'getGalleryImages'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'getUpdateToken',
        [_dec20, auth, _dec21],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'getUpdateToken'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'delImages',
        [_dec22, auth, _dec23, _dec24],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'delImages'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'editImages',
        [_dec25, auth, _dec26, _dec27],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'editImages'),
        _class2.prototype
      ),
      _applyDecoratedDescriptor(
        _class2.prototype,
        'setGalleryCover',
        [_dec28, auth, _dec29],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'setGalleryCover'),
        _class2.prototype
      )),
      _class2))
  ) || _class)
